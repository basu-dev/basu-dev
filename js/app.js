...
(function (d) {
  ...
  const projects = [
    ...
    },
    {
      ...
      repo: "https://github.com/basu-dev/django-social-network-like-Facebook-or-Instagram",
    },

    {
      title: "Typeracer Mini",
      techUsed: "Angular",
      description:
        "Practice Touch Typing and become a typing professional in a month.",
      live: "https://typeracermini.netlify.app",
      repo: "https://github.com/basu-dev/typeracer-clone",
      image: "typeracermini.jpg",
    },
    ...
    //   repo: "https://github.com/basu-dev/far-A-command-prompt-text-viewer-like-cat-for-linux",
    // },
    {
  ...
  const projectTemplate = (
    ...
    return /*html*/ `
          ...
          <div class="project-img">
            <img loading="lazy"  src="./images/${image}" alt="${title}">
          </div>
          <div class="header">
            <h2>${title}</h2>
...
`;
  ...
  const timeline = [
    ...
    },
    {
      ...
      date: "2019",
      event:
        "Started as Full Stack Web Developer at B&BMultimedia and at the same time started learning Angular.",
    },
    {
      number: 3,
      date: "2018",
      event:
        "Made some blog websites with Python Django and learnt jQuery. Made the Raven- A Social Network project in Django and jQuery and made website for B&B Multimedia.",
    },
    {
      number: 2,
      date: "2017",
      event:
        "Started Learning HTML, JavaScript & CSS and started making basic Web Pages with static contents. At the end of the year I was already learning Python for backend.",
    },
    {
      number: 1,
      date: "2016",
      event:
        "Started as Electronics & Communication Enginnering at WRC, Pokhara. Learnt C as first programming language. Started to know about programming language like C, C#, Python etc",
    },
  ];
